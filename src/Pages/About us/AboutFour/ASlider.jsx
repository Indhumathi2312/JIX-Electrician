...
import Client1 from "../../../assets/S1.svg";
import Client2 from "../../../assets/S2.svg";
import Client3 from "../../../assets/S3.svg";
import Client4 from "../../../assets/S4.svg";
import Client5 from "../../../assets/S5.svg";

const ASlider = () => {
  const images = [Client1, Client2, Client3, Client4, Client5, Client1, Client2, Client3, Client4, Client5];
  return (
    <>
